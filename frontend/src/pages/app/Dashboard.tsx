...
export const Dashboard = () => {
  ...
  const listErrorMessage = error ? getErrorMessage(error, "Failed to load ideas") : "";
  const deleteErrorMessage = deleteIdea.error
    ? getErrorMessage(deleteIdea.error, "Failed to delete idea")
    : "";
